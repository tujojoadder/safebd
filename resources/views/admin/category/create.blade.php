...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Category Create</div>
            <div class="ps-3">
                        ...
                        <div class="row">
                           <div class="col-12">
                                ...
                                <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                  <input type="text" name="category_name_en" class="form-control border-start-0" id="category_name_en" placeholder="Enter Category Name English" />
                                </div>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                  <input type="text" name="category_name_bn" class="form-control border-start-0" id="category_name_bn" placeholder="Enter Category Name Bangla" />
                                </div>
                           ...
                           <div class="col-md-12 mt-3">
                              <div class="form-group">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="featured_category" name="featured_category"  value="1">

...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">SubCategory Create</div>
            <div class="ps-3">
                        ...
                        <div class="row">
                           ...
                           <div class="col-12 mt-2">
                                ...
                                <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                  <input type="text" name="subcategory_name_en" class="form-control border-start-0" id="subcategory_name_en" placeholder="Enter SubCategory Name English" />
                                </div>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                  <input type="text" name="subcategory_name_bn" class="form-control border-start-0" id="subcategory_name_bn" placeholder="Enter SubCategory Name Bangla" />
                                </div>

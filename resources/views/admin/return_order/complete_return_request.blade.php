...
<div class="page-wrapper">
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Complete Return Order List</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <!--end breadcrumb-->
        <span class="badge badge-success rounded-pill" style="font-size: 18px;"> Complete Return Order List Count ({{ count($orders) }}) </span>
        <hr/>
        <div class="card">
            <div class="card-body">

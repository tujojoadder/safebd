...
.img-bg::before {
  content: "";
  background: url(../images/team/dot_bg.html);
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
.textEffect2 {
  background: url(../images/templates1.html);
...
.modern-invoice3 {
  ...
  padding: 50px;
  overflow: hidden;
  border-bottom: 26px solid #f73e4c;
}
@media (max-width: 991px) {
  .modern-invoice3 {
    padding: 30px;
    ...
    <main class="main-wrapper position-relative">
        <div class="modern-invoice3" id="download-section">
            ...
            <div class="invoice-top">
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 text-center text-sm-start mb-3 mb-sm-1">
                        <img src="{{ asset('frontend/payment/eshop.png') }}"  width="70%" title="invoice" alt="invoice">
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 text-center text-sm-end mb-3 mb-sm-1">
                        <h4 class="text-35 text-uppercase mb-0 mt-0" style="font-weight:bolder !important;color:#f73e4c;!important;">Invoice</h4>
						 <p class="text-uppercase mb-0 mt-0" style="font-weight:bolder !important;color:black;!important;">Invoice No: {{ $order->invoice_no ?? '' }}</p>
						 <p class="text-uppercase mb-0 mt-0" style="font-weight:bolder !important;color:black;!important;">Invoice Date: {{ date('d-m-Y', $order->date) }}</p>
                    </div>
                </div>
                <hr>
            </div>
            ...
            <div class="invoice-details pt-20">
                <div class="row">
                    <div class="col-sm-6 text-sm-end order-sm-1">
                        ...
                        <address class="mb-4">
                            <strong style="font-weight:bolder !important;color:black;!important;">Eshopttka</strong><br>
                             {{ $order->user->name ?? 'Null' }}<br>
                            {{ $order->user->email ?? 'Null' }}<br />
							 {{ $order->user->phone ?? 'Null' }}<br />
							 {{ ucwords($order->upazilla->name_en ?? '') }}<br />
                             {{ ucwords($order->district->district_name_en ?? '') }}<br />
                            {{ ucwords($order->division->division_name_en ?? '') }} <br />
                        </address>
                    </div>
                    <div class="col-sm-6 order-sm-0">
                        ...
                        <address class="mb-4">
                            ...
                            {{ get_setting('email')->value ?? 'null' }}<br>
							{{ get_setting('phone')->value ?? 'null' }}
                        </address>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive invoice-table mb-4">
                <table class="table table-striped" style="border:1px solid gray; !important;">
                    <thead>
                        <tr>
                            <th>SL No</th>
							 <th>Product Image</th>
                            <th style="border-right:1px solid gray; !important;background-color:000000; !important;">Product Name</th>
                            <th class="black-bg" style="background-color:black; !important;">Price</th>
                            <th class="black-bg" style="background-color:black; !important;">Quantity</th>
							 <th class="black-bg" style="background-color:black; !important;">Total</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 ms-auto">
                    <table class="table">
                        <tbody>
							...
							<tr>
                                <td>
                                    <strong class="status">Shipping Cost</strong>
                                </td>
                                <td> {{ $order->order_Detail->shipping_cost ?? '0.00' }}</td>
                            </tr>
                            <tr class="total-pay">
                                ...
                                <td class="border-bottom-0">
                                    <strong>{{ $order->grand_total ?? '0.00' }}</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row">
				 <div class="col-sm-12 mb-20">
					<div class="payment-method mb-30">
						...
						<p class="text-uppercase mb-0 mt-0" style="color:black;!important;">Payment Method: {{ $order->payment_method ?? '' }}</p>
						 <p class="text-uppercase mb-0 mt-0" style="color:black;!important;">Account Name: {{ $order->user->name ?? '' }}</p>
					</div>
				</div>
                <div class="col-sm-12 mb-20">
                    <span class="status d-block mb-20"> <strong>Date :</strong> {{ date('d-m-Y', $order->date) }}</span>
            ...
            <div class="signature text-right">
                ...
                <p class="text-title">Your Designation</p>
            </div>
				 <div class="row" style="padding-top:50px;">
				 <div class="col-sm-4 mb-5" >
					 <a href="tel:{{ get_setting('phone')->value ?? 'null' }}"
                                                class="d-flex" style="color:black;"><i class="fa fa-phone" style="margin-right: 10px; font-size: 20px;background: black;padding: 4px 7px;border-radius: 50px;color: #fff;"></i>
                                                {{ get_setting('phone')->value ?? 'null' }}</a>
				</div>
			  <div class="col-sm-4 mb-5"><a href="tel:{{ get_setting('phone')->value ?? 'null' }}"
                                                class="d-flex" style="color:black;"><i class="fa fa-envelope" style="margin-right: 10px; font-size: 20px;background: black;padding: 4px 7px;border-radius: 50px;color: #fff;"></i>
                                                {{ get_setting('email')->value ?? 'null' }}</a></div>
			  <div class="col-sm-4 mb-5"><a href="tel:{{ get_setting('phone')->value ?? 'null' }}"
                                                class="d-flex" style="color:black;"><i class="fa fa-map-marker" style="margin-right: 10px; font-size: 20px;background: black;padding: 4px 7px;border-radius: 50px;color: #fff;"></i>
                                                {{ get_setting('business_address')->value ?? 'null' }}</a></div>
		</div>
        </div>
        <!-- invoice Bottom  -->

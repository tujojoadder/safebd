            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Publish Review List</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('pending.review') }}" class="btn btn-success">Pending Review</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                        ...
                        <tbody>
                            @foreach($review as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('review.delete',$item->id) }}" id="delete" class="btn btn-danger btn-sm px-1">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>

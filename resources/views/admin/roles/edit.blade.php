...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('all.roles') }}" class="btn btn-primary">Roles List</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                              <input type="text" name="name" value="{{ $roles->name }}" class="form-control border-start-0" id="name" placeholder="Enter role name" />
                            </div>
                            @error('name')

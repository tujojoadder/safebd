            ...
            <form method="post" action="{{ route('search-by-month')}}">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <select name="month" class="form-select single-select mb-3" aria-label="Default select example">
                        ...
                        <select name="year_name" class="form-select single-select mb-3" aria-label="Default select example">
            ...
            <form method="post" action="{{ route('search-by-year')}}">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <label class="form-label">Select Year:</label>
                        <select name="year" class="form-select single-select mb-3" aria-label="Default select example">
                            <option selected="">Open this select Year</option>
                            <option value="2021">2021</option>
                            <option value="2022">2022</option>
                            <option value="2023">2023</option>

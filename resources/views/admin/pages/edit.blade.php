...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Pages Edit</div>
            <div class="ps-3">
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                              <input type="text" name="name_en" value="{{ $page->name_en }}" class="form-control border-start-0" id="name_en" placeholder="Enter Page Name English" />
                            </div>
                            @error('name_en')
                           ...
                           <div class="col-12 mt-2">
                            ...
                            <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                              <input type="text" name="name_bn" value="{{ $page->name_bn }}" class="form-control border-start-0" id="name_bn" placeholder="Enter Page Name Bangla" />
                            </div>
                            @error('name_bn')
                              <span class="text-danger">{{ $message }}</span>
                            @enderror
                          ...
                          <div class="col-12 mt-2">
                            ...
                            <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                              <input type="text" name="title" value="{{ $page->title }}" class="form-control border-start-0" id="title" placeholder="Enter Pages Title" />
                            </div>
                            @error('title_bn')
                              <span class="text-danger">{{ $message }}</span>
                            @enderror
                          ...
                          <div class="col-md-12 mt-2">
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <textarea class="form-control" name="description_en" id="description_en" rows="3" placeholder="Enter Description English">{{ $page->description_en }}</textarea>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <textarea class="form-control" name="description_bn" id="description_bn" rows="3" placeholder="Enter Description Bangla">{{ $page->description_bn }}</textarea>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-12 mt-2">
                              <div class="form-group">
                                  ...
                                  <select name="position" id="position" class="form-control form-select">
                                    ...
                                    @if ($page->position == 3)
                                       <option value="2">Both</option>
                                       <option value="3" selected>Bottom</option>
                                       <option value="1">Nav</option>
                                    @endif
                                  </select>
                              </div>

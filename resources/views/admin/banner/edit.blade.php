...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Banner Create</div>
            <div class="ps-3">
                        ...
                        <div class="row">
                          <div class="col-md-12 mt-3">
                              <div class="form-group">
                                <label for="banner_image">Banner Image <span class="text-light font-weaight-bolder">(Size:390,132):</span></label>
                                ...
                                <div class="input-group mb-3">
                                  <input type="file" class="form-control image" name="banner_image" id="slider_img">

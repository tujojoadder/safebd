              ...
              <!--  <div class="search-bar flex-grow-1">
                     ...
                     <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            @if(Auth::user()->unreadNotifications->count() > 0)
                              <span class="alert-count"> {{\Auth::user()->Notifications->count() }}</span></span>
                            @endif
                                    ...
                                    <div class="flex-grow-1">
                                       <h6 class="msg-name">New Orders
                                          <span class="msg-time float-end">
                                             {{ date("F j Y, g:i a", strtotime($notification->created_at)) }} ago
                                          </span>
                                       </h6>
                                       <p class="msg-info"> Order code: {{$notification->data['order_code']}} <br> has been {{$notification->data['status']}}</p>
                                    </div>
                                 </div>
                              </a>
                              @empty
                                 <p class="msg-info p-3 text-center">No notification found</p>
                              @endforelse
                             <!--  <a class="dropdown-item" href="javascript:;">
                                 <div class="d-flex align-items-center">
               ...
               <div class="user-box dropdown">
                  <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                     <img src="{{ (!empty($adminData->profile_photo)) ? url('upload/user_images/'.$adminData->profile_photo):url('upload/no_image.jpg') }}" class="user-img" alt="user avatar">
                     <div class="user-info ps-3">
                        <p class="user-name mb-0">{{ Auth::user()->name}}</p>
                     </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                     <li><a class="dropdown-item" href="javascript:;"><i class="bx bx-user"></i><span>Profile View</span></a>
                     </li>
                     <li><a class="dropdown-item" href="javascript:;"><i class="bx bx-user"></i><span>Password Change</span></a>
                     </li>
                     <li><a class="dropdown-item" href="{{ route('setting.index') }}"><i class="bx bx-cog"></i><span>Settings</span></a>
                     </li>
                     <li>

...
<div class="page-wrapper">
    <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Blog Create</div>
            <div class="ps-3">
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                              <input type="text" name="blog_title_en" class="form-control border-start-0" id="blog_title_en" placeholder="Enter Blog Title English" />
                            </div>
                            @error('blog_title_en')
                          ...
                          <div class="col-12 mt-2">
                            ...
                            <div class="input-group input-group-lg"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                              <input type="text" name="blog_title_bn" class="form-control border-start-0" id="blog_title_bn" placeholder="Enter Blog Title Bangla" />
                            </div>
                            @error('blog_title_bn')
                              <span class="text-danger" style="font-weight:bolder;">{{ $message }}</span>
                            @enderror
                          ...
                          <div class="col-md-12 mt-2">
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <textarea class="form-control" name="blog_description_en" id="blog_description_en" rows="3" placeholder="Enter Description English"></textarea>
                              </div>
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                <textarea class="form-control" name="blog_description_bn" id="blog_description_bn" rows="3" placeholder="Enter Description Bangla"></textarea>
                              </div>
                            </div>
                          </div>

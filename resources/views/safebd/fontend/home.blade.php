    ...
    <section class="blood-section">
        <div class="container">
            ...
            <div class="blood-grid">
                @foreach ([['group' => 'A+', 'count' => $members->where('blood', 1)->count() ?? 0],
                 ['group' => 'A-', 'count' => $members->where('blood', 2)->count() ?? 0], 
                 ['group' => 'AB+', 'count' => $members->where('blood', 3)->count() ?? 0],
                 ['group' => 'AB-', 'count' => $members->where('blood', 4)->count() ?? 0],
                 ['group' => 'B+', 'count' => $members->where('blood', 5)->count() ?? 0],
                 ['group' => 'B-', 'count' => $members->where('blood', 6)->count() ?? 0],
                 ['group' => 'O+', 'count' => $members->where('blood', 7)->count() ?? 0],
                 ['group' => 'O-', 'count' => $members->where('blood', 8)->count() ?? 0]] as $blood)
                    <div class="blood-card">
                        <img src="https://cdn-icons-png.flaticon.com/512/2913/2913133.png" alt="Blood"
                            class="blood-drop" />

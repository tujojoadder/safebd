              ...
              <div class="card-body">
                 ...
                 <article class="card">
                    <div class="card-body row">
                       ...
                       <div class="col"> <strong>Shipping BY:</strong> <br> {{ $track->name }} | <i class="fa fa-phone"></i> {{ $track->phone }} / {{ $track->division->name_en }} / {{ $track->district->name_en }} / {{ $track->upazilla->name_en }} / {{ $track->union->name_en }}   </div>
                       <div class="col"> <strong>Payment Method:</strong> <br>{{ $track->payment_method }} </div>
                       <div class="col"> <strong>Total Amount:</strong> <br>৳{{ $track->grand_total }}</div>
                    </div>
                 </article>
                 <div class="track">
                    @if($track->delivery_status == 'pending')           
                 ...
                 <hr>
                 <a href="{{ route('user.track.order') }}" class="ps-btn" data-abc="true"> <i class="fa fa-chevron-left"></i> Back to orders</a>
              </div>
           </article>
        </div>
    </div>

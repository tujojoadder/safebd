        ...
        <ul class="breadcrumb">
            ...
            <li>
            	@if(session()->get('language') == 'bangla')
					{{ $subcategory->subcategory_name_bn ?? 'NULL' }}
				@else
					{{ $subcategory->subcategory_name_en ?? 'NULL' }}
				@endif
            </li>
        </ul>
    </div>
            ...
            <div class="ps-layout__left">
                <form action="{{ URL::current() }}" method="GET">
                    <aside class="widget widget_shop">
                        ...
                        <h4 class="widget-title mt-5">BY SUBCATEGORIES</h4>
                        <figure class="ps-custom-scrollbar" data-height="250">
                            @foreach($filter_subcategories as $subcategory)

                                @php
                                    $subcategory_product = App\Models\Product::where('subcategory_id',$subcategory->id)->paginate(10);

                                @endphp
                                @php
                                    $checked = [];
                                    if(isset($_GET['filtersubcategory'])){
                                        $checked = $_GET['filtersubcategory'];
                                    }
                                @endphp
                                <div class="ps-checkbox">
                                    <input class="form-control" type="checkbox" id="subcategory_filter{{$subcategory->id}}" name="filtersubcategory[]" value="{{$subcategory->subcategory_name_en}}" @if(in_array($subcategory->subcategory_name_en, $checked)) checked @endif />

                                    <label  for="subcategory_filter{{$subcategory->id}}">{{ $subcategory->subcategory_name_en }} ({{ count($subcategory_product) }})</label>
                                </div>
                            @endforeach
                        </figure>
                                        ...
                                        <div class="ps-product ps-product--inner mb-5">
                                            <div class="ps-product__thumbnail">
                                                ...
                                                <a class="ps-product__vendor mt-3" href="#">
                                                    @if(session()->get('language') == 'bangla')
                                                    {{ $product->subcategory->subcategory_name_bn ?? 'NULL' }}
                                                    @else
                                                    {{ $product->subcategory->subcategory_name_en ?? 'NULL' }}
                                                    @endif
                                                </a>

    ...
    $('#division_id').on('change', function() {
        ...
        if (divisionId) {
            $.ajax({
                ...
                error: function() {
                    districtSelect.html('<option value="">জেলা লোড করতে ব্যর্থ</option>');
                }
            });
        } else {
    ...
    $('#district_id').on('change', function() {
        ...
        if (districtId) {
            $.ajax({
                ...
                dataType: 'json',
                success: function(data) {
                    upazilaSelect.html('<option value="">থানা/উপজেলা নির্বাচন করুন</option>');
                ...
                error: function() {
                    upazilaSelect.html('<option value="">উপজেলা লোড করতে ব্যর্থ</option>');
                }
            });
        } else {
            upazilaSelect.html('<option value="">প্রথমে জেলা নির্বাচন করুন</option>');

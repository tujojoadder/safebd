...
class RoleController extends Controller
{
    ...
    public function StorePermission(Request $request){
        ...
        $permission_unique_check = Permission::where('name',$request->name)->first();

        if($permission_unique_check){
            $notification = array(
    ...
    public function AdminEditRoles($id){
        ...
        $permissions = Permission::all();
        $permission_groups = User::getpermissionGroups();
        return view('admin.roles.edit_roles_permission',compact('role','permissions','permission_groups'));
